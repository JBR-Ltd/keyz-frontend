...
const cityCards = [
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1519501025264-65ba15a82390?w=800&h=600&fit=crop&auto=format&q=80",
    alt: "Lagos cityscape",
  },
  {
    city: "Abuja",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1575517111478-7f6afd0973db?w=800&h=600&fit=crop&auto=format&q=80",
...
const bentoCells = [
  {
    ...
    description:
      "Every property on Rello is manually verified before it goes live. No fake listings, no surprises.",
  ...
  {
    title: "Secure Escrow",
    description: "Your payment is held safely until handover.",
  ...
  },
  {
    ...
    description:
      "Covering Nigeria's biggest property markets with more cities coming soon.",
    className:
      "border border-[color-mix(in_srgb,var(--color-primary)_10%,transparent)] bg-[color-mix(in_srgb,var(--color-primary)_5%,var(--color-bg))] text-primary lg:col-span-2",
  ...
  },
  {
    ...
    description:
      "Landlords on Rello respond fast. No more waiting days to hear back on a viewing.",
    className:
...
export default function MarketingLandingPage(): ReactElement {
  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg)] text-primary">
      ...
      <section className="grid min-h-screen overflow-hidden bg-primary lg:grid-cols-[55fr_45fr]">
        <div className="flex min-h-screen items-center px-6 py-28 text-center sm:px-10 lg:px-16 lg:text-left">
          <div className="mx-auto max-w-xl lg:mx-0">
            ...
            >
              Verified listings across Lagos, Abuja, and Port Harcourt. No
              hidden fees, no agent stress.
            </motion.p>
            <motion.div
            ...
            >
              {trustItems.map((item) => (
                <span
                  key={item}
                  className="inline-flex items-center justify-center gap-2 lg:justify-start"
                >
      ...
      <section
        id="cities"
        className="bg-[var(--color-bg)] px-4 py-24 sm:px-6 lg:px-8"
      >
      ...
      <section
        ...
        className="bg-primary px-4 py-24 sm:px-6 lg:px-8"
      >
        <div className="mx-auto max-w-7xl">
          <motion.div {...(reduceMotion ? {} : reveal())}>
            ...
            <h2 className="mb-12 mt-2 font-display text-4xl font-bold text-white">
              Handpicked for you.
            </h2>
          </motion.div>
            ...
            {bentoCells.map((cell, index) => {
              ...
              return (
                ...
                >
                  ...
                  {Icon ? (
                    <Icon
                      className={`h-10 w-10 ${cell.iconClassName}`}
                      aria-hidden="true"
                    />
                  ) : null}
                  <h3
                    className={`mt-4 font-display text-2xl font-bold ${cell.titleClassName}`}
                  >
                    {cell.title}
                  </h3>
                  <p
                    className={`mt-2 font-body text-sm leading-6 ${cell.descriptionClassName}`}
                  >
                    {cell.description}
                  </p>
                </motion.article>
      ...
      <section className="bg-accent px-4 py-32 text-center sm:px-6 lg:px-8">
        <motion.div
          ...
          {...(reduceMotion ? {} : reveal())}
        >
          <h2 className="font-display text-5xl font-bold leading-tight text-primary">
