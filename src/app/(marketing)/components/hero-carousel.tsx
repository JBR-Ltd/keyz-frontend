      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-81px)] max-w-7xl items-end px-4 pb-10 pt-16 sm:px-6 sm:pb-12 lg:px-8 lg:pb-16">
        <div className="w-full">
          ...
          >
            ...
            <motion.h1
              className="font-display max-w-3xl text-5xl font-bold leading-tight text-white sm:text-6xl lg:text-7xl"
              variants={{
            ...
            <motion.p
              className="mt-4 max-w-2xl text-lg font-semibold text-[#FDE0A6] sm:text-xl"
              variants={{
                hidden: { opacity: 0, y: 24 },
                show: { opacity: 1, y: 0, transition: { duration: 0.6 } },
              }}
