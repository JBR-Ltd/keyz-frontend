    ...
    cases: [
      {
        ...
        meta: "Upload the signed inspection report",
      },
      {
        id: "DSP-2019",
        title: "Access key delay",
        meta: "Reply to the tenant timeline",
      },
    ],
  },
  {
    ...
    cases: [
      {
        id: "DSP-2007",
        title: "Payout release hold",
        meta: "Mediator reviewing both statements",
      },
    ],
  },
  {
    ...
    cases: [
      {
        id: "DSP-1988",
        title: "Utility charge correction",
        meta: "Closed Jul 08",
      },
    ],
  },
...
const EVIDENCE = [
  { label: "Inspection report", value: "Draft", icon: FileText },
  { label: "Property photos", value: "12 files", icon: FileImage },
  { label: "Tenant thread", value: "18 messages", icon: MessageSquareText },
];
    ...
    <main className="min-h-screen overflow-x-hidden px-5 py-10 sm:px-8 lg:px-10 lg:py-14 xl:px-14">
      <header className="flex flex-col gap-6 pb-8 xl:flex-row xl:items-end xl:justify-between">
        <div>
          ...
          <p className="mt-4 max-w-2xl font-body text-base leading-7 text-muted">
            Track tenant responses, property evidence, and mediator decisions
            across disputed bookings.
          </p>
        </div>
        <div className="rounded-lg bg-accent/10 p-5 shadow-sm">
          <p className="flex items-center gap-2 font-body text-sm font-bold text-primary">
            ...
            One case needs landlord evidence today
          </p>
        </div>
      </header>
      ...
      <section className="grid gap-5 xl:grid-cols-[1fr_21rem]">
        ...
        <aside className="rounded-lg bg-[var(--color-bg)] p-6 text-primary shadow-sm">
          ...
          <h2 className="mt-3 font-display text-3xl font-bold">DSP-2042</h2>
          <p className="mt-3 font-body text-sm leading-6 text-muted">
            Move-in condition review for Lekki Garden Maisonette. Add the signed
            inspection report before mediator assessment begins.
          </p>
          ...
          <button
            type="button"
            className="mt-8 flex w-full items-center justify-center gap-2 rounded bg-accent px-5 py-4 font-accent text-xs font-bold uppercase tracking-[0.16em] text-primary transition-all duration-200 ease-in-out hover:bg-primary hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
          >
