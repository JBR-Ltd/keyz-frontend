        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <div>
                <p className="font-bold text-primary text-base tracking-wide leading-tight">
                  KEYZ
                </p>
            ...
            <p className="text-gray-500 text-xs leading-relaxed mb-5">
              Keyz Real Estate is your trusted platform for buying, renting and
              managing properties with confidence and ease
            </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="w-8 h-8 rounded-full bg-gradient-to-br from-[#f09433] via-[#e6683c] to-[#dc2743] flex items-center justify-center hover:opacity-80 transition-opacity"
              >
                <svg
                  width="14"
                  height="14"
          ...
          {Object.entries(FOOTER_LINKS).map(([heading, links]) => (
            <div key={heading}>
              <p className="font-bold text-primary text-sm mb-4">{heading}</p>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <button className="bg-primary hover-bg-primary-dark transition-colors text-white w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0">
